...
/*		Modified for MSP430 with hardware SPI
			Paul Young - november 2019
*/
...
#include <hal_SPI.h>			/* Include device specific declareation file here */
...
{
	spiSendFrame((unsigned char *)buff, (unsigned int)bc);
}



/*-----------------------------------------------------------------------*/
/* Receive bytes from the card (hardware SPI)                            */
/*-----------------------------------------------------------------------*/
...
{
	spiReadFrame((unsigned char *)buff, (unsigned int)bc);
}
